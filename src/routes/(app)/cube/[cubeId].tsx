...
const CubeLayout = () => {
  ...
  const [cubeNavOpen, setCubeNavOpen] = createSignal<true | false>(false);
  ...
  const CubeNav = () => (
    <nav>
      <ul class={styles.cubeNav}>
        ...
        <li>
          <A href={`/cube/compare`} inactiveClass={styles.cubeNavLinkLarge} activeClass={styles.cubeNavLinkLargeActive}>
            Compare
          </A>
        </li>
        <li>
