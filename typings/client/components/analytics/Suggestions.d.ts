...
declare namespace Suggestions {
    namespace propTypes {
        const adds: PropTypes.Validator<NonNullable<PropTypes.InferProps<{
            card: PropTypes.Validator<NonNullable<PropTypes.InferProps<{
        ...
        const cuts: PropTypes.Validator<NonNullable<PropTypes.InferProps<{
            card: PropTypes.Validator<NonNullable<PropTypes.InferProps<{
                addedTmsp: PropTypes.Requireable<NonNullable<string | Date | null | undefined>>;
                cardID: PropTypes.Validator<string>;
                cmc: PropTypes.Requireable<number>;
